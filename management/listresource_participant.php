            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a href="./organizer_view.php?id=<?php echo $row2['id'] ?>" class="dropdown-item">Organizer View</a>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div role="document" class="modal-dialog">
            <div class="card card-profile">
              <div class="card-body">
                ...
                <a href="listresources-participant.php" class="btn btn-success">Yes</a>
              </div></center>
              </div>
            </div>
          </div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"fetch_resource2.php?id=<?php echo $row2['id'] ?>",
   method:"POST",
   data:{query:query},
