 ...
 while($row = mysqli_fetch_array($result))
 {
  ...
  $output .= '
   <tr>
    ...
    <!--<td><a class="btn btn-info btn-sm" href="request-resources.php?id='.$id1.'">Request</a></td>-->
	<td><a href="" class="material-icons text-danger" data-action="delete" data-body-message="Are you sure to delete this data?" data-redirect-url="delete-resources.php?id='.$id1.'">delete</a></td>
   </tr>
  ';
  $bil++;
 }
