                ...
                <div class="card-header card-header-primary">
                  <div class="row">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                      ...
                      <a href="listresource_participant.php?id=<?php echo $row2['id'] ?>" class="btn btn-info btn-sm">Participant View</a>&emsp;
                      <a href="addresource.php?id=<?php echo $row2['id'] ?>" class="btn btn-warning btn-sm">Add Resource</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
            ...
            <div class="card card-profile">
              <div class="card-body">
                <div class="modal-header">
                  <h4 id="login-modalLabel" class="modal-title h5">Participant View</h4>
                ...
                <a href="listresource_participant.php" class="btn btn-success">Yes</a>
              </div></center>
              </div>
            </div>
          </div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"fetch_resource.php?id=<?php echo $row2['id'] ?>",
   method:"POST",
   data:{query:query},
