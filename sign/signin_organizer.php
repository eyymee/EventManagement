...
<?php
  ...
  if(isset($_POST['login']))
  {
      ...
      $check_user="select * from organizer WHERE email='$email'AND password='$password'";

      $run=mysqli_query($conn,$check_user);

      if(mysqli_num_rows($run))
      {
          echo "<script>window.open('../management/home_organizer.php','_self')</script>";
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="signup_organizer.php" class="signup-image-link">Create an account</a>
                    ...
                    <div class="signin-form">
                      <?php if($error != "") {
                        ...
                        <h2 class="form-title">Organizer</h2>
                        <form method="POST" class="register-form" action="signin_organizer.php" id="login-form">
